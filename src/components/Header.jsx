      ...
      <div className={!color ? "nav" : "nav nav-color"}>
        <div className='nav-container'>
          <div className="left-section">
            <Link className="portfolio" smooth={true} spy={true} activeClass='active' offset={0} to="/" style={{fontFamily:'"Orbitron", sans-serif',fontSize:"2rem"}}>MANOJ'S</Link>
          </div>
          ...
          <div className='right-section'>
            ...
            <ul className= "right-content">
              ...
              <li className="item">
                <a className="link" target='_blank' rel="noreferrer" href="https://github.com/manoj-aerlync"><Github fill='#ccc' width="100%" height="100%" /></a>
              </li>
              {/* <li className="item">
              ...
              <li className="item">
                <a className="link" target='_blank' rel="noreferrer" href="https://www.linkedin.com/in/manoj-kumar-k-2740b9246/"><Linkedln fill="#ccc" width="100%" height="100%" /></a>
              </li>
